...
export default function SelectedLot({selectedLot}: {selectedLot: lot}){
    return (
        <div className="w-96 m-auto">
            ...
            <p><span className="font-semibold">Price: </span>{selectedLot.price === "N/A" ? selectedLot.price: ("$" + selectedLot.price.toString().slice(0,3) + "," + selectedLot.price.toString().slice(3,6))}</p>
            ...
            <p><span className="font-semibold">Frontage: </span>{selectedLot.frontage}</p>
        </div>
    )
}